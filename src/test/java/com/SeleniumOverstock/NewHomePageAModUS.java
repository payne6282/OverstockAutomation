...
public class NewHomePageAModUS {
	...
	public void FirefoxTest() throws InterruptedException, IOException {
		...
		for(int  counter = 0; counter < xpathURL.size(); counter++)
		{
			...
			/*.//*[@id='amodCarousel']/div[1]/div/a
			.//*[@id='amodCarousel']/div[2]/div/a
			.//*[@id='amodCarousel']/div[3]/div/a*/
		...
		/*String xpath2 = "]/a";
			...
			System.out.println("Amod is " +Amod.get(counter));
		}
